...
2. Please choose precisely one of the following actions to take: [present facts, ask a question, empathize, confirm common ground, or share a personal story]
...
def start_persuasive_conversation(topic: str):
    ...
    while True and num_turns < MAX_CONVERSATION_LENGTH:
        ...
        agent_response = chain.invoke(
            {"topic": topic, "conversation_history": conversation_history_str, "user_input": user_input})
